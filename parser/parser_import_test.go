...
func TestParserImportModule(t *testing.T) {
	...
	importStmt := stmt.NamespaceImports()[0].(*parser.ImportNamespaceStatement)
...
func TestParserImportDirectory(t *testing.T) {
	...
	importStmt := stmt.NamespaceImports()[0].(*parser.ImportDirectoryStatement)
...
`
	...
	dirStmt := stmt.NamespaceImports()[0].(*parser.ImportDirectoryStatement)
	...
	namespaceStmt := stmt.NamespaceImports()[1].(*parser.ImportNamespaceStatement)
